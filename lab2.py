...
# Added code for lab submission
weapons = ["Fist", "Knife", "Club", "Gun", "Bomb", "Nuclear Bomb"]
input("Roll the dice for the weapon you must use (Press enter)")
weaponRoll = random.randint(0, 5)
print("You rolled a " + weapons[weaponRoll] + " as your weapon, with a combat strength of " + str(weaponRoll + 1))
